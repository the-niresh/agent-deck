...
1. A concise, descriptive title that summarizes the changes, postfixed with "(Agent Deck)"
2. A detailed description that explains:
   - What changes were made
   - Why they were made (based on the task context)
   - Any important implementation details
   - At the end, include a note: "This PR was written using [Agent Deck](https://github.com/the-niresh/agent-deck)"
