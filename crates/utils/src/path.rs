...
pub fn get_agent_deck_temp_dir() -> std::path::PathBuf {
    ...
    if cfg!(target_os = "macos") {
        ...
        // Windows and other platforms: use temp dir with agent-deck subdirectory
        std::env::temp_dir().join(dir_name)
    }
}
...
mod tests {
    ...
    fn test_make_path_relative_macos_private_alias() {
        ...
        let worktree = "/var/folders/zz/abc123/T/agent-deck-dev/worktrees/vk-test";
