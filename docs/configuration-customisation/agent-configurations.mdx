...
<Info>
Agent profiles are used throughout Agent Deck wherever agents run: onboarding, default settings, attempt creation, and follow-ups.
</Info>
...
<Note>
The configuration page displays the exact file path where your settings are stored. Agent Deck saves only your overrides whilst preserving built-in defaults.
</Note>
...
<Card title="MCP Server Configuration" icon="server" href="/integrations/mcp-server-configuration">
  Configure MCP servers within Agent Deck for your coding agents
</Card>

<Card title="Agent Deck MCP Server" icon="plug" href="/integrations/agent-deck-mcp-server">
  Connect external MCP clients to Agent Deck's MCP server
</Card>
</CardGroup>
