---
title: "Get Started"
description: "Launch Agent Deck, connect a coding agent, and go from zero to pull request"
sidebarTitle: "Get Started"
---

Agent Deck keeps you organised while running multiple coding agents in parallel by streamlining how you plan and review their work.

## 1. Launch Agent Deck

Start the Agent Deck client and open the UI in your browser:
...
The first time you run Agent Deck, you'll be asked to set your preferred:
...
## 3. Sign-in to Agent Deck

You can use a GitHub or Google account.

<Frame>
  <img src="/images/onboarding-sign-in.png" alt="Agent Deck onboarding screen showing Sign in to continue with GitHub and Google buttons" />
</Frame>
...
**Issues** are a core concept of Agent Deck, they represent a bug, feature or piece of work to be done. At a minimum, issues consist of a title and description, but you can also add priorities, tags and even connect issues together with parent/child relationships.
...
**Workspaces** are another core concept of Agent Deck, they represent a space to work on an issue with a coding agent. When you create a workspace, Agent Deck automatically creates git worktrees for your selected repositories, and launches your coding agent.
