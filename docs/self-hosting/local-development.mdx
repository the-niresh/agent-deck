...
description: "Run Agent Deck Cloud locally"
---

This guide walks you through setting up a local Agent Deck Cloud instance for development and testing.
...
3. Fill in the details:
   - **Application name**: Agent Deck Local
...
AGENTDECK_REMOTE_JWT_SECRET=<paste_your_generated_secret_here>
...
Open [http://localhost:3000](http://localhost:3000) in your browser. You should see the Agent Deck Cloud login page.
