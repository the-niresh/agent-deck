...
description: "Solutions for common issues with Agent Deck Cloud"
---

This page covers common issues you might encounter with Agent Deck Cloud and how to resolve them.
...
4. Return to Agent Deck and sign in again
</Accordion>
...
3. Try a different browser
4. Restart Agent Deck (`npx agent-deck`)
</Accordion>
...
1. **Check existing issues:** [github.com/the-niresh/agent-deck/issues](https://github.com/the-niresh/agent-deck/issues)
...
<Card title="Report an Issue" icon="github" href="https://github.com/the-niresh/agent-deck/issues/new">
