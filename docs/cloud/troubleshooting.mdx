...
1. **Check existing issues:** [github.com/BloopAI/agent-deck/issues](https://github.com/BloopAI/agent-deck/issues)
...
<Card title="Report an Issue" icon="github" href="https://github.com/BloopAI/agent-deck/issues/new">
