---
title: "Agent Deck Cloud"
description: "Collaborate with your team in real-time with Cloud features"
sidebarTitle: "Overview"
---

## What is Agent Deck Cloud?

**Agent Deck Cloud** adds team collaboration to Agent Deck. Your projects, issues, and progress sync to the cloud so your entire team stays in sync.
...
<Card title="Same Interface" icon="desktop">
  Cloud uses the same Agent Deck interface you already know. No new tools to learn.
</Card>
</CardGroup>
...
<Info>
You can use both Local and Cloud projects in the same Agent Deck installation. They appear in separate sections of the sidebar.
</Info>

## How It Works

1. **Run Agent Deck** as usual with `npx agent-deck`
...
Think of it as your company or team in Agent Deck.
...
- Review code directly in Agent Deck
- Track PR status

## Getting Started

<Steps>
<Step title="Run Agent Deck">
  ```bash
  npx agent-deck
  ```
</Step>
