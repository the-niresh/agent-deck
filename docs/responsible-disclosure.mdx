...
description: "How to report security vulnerabilities to Agent Deck responsibly"
---

**Last updated:** *February 28, 2026*

At **Agent Deck**, we take the security of our platform and the safety of
...
If you believe you've discovered a vulnerability in Agent Deck that falls
...
- https://your Agent Deck host (remote server)
- https://your Agent Deck relay (relay server)
...
- Social engineering targeting Agent Deck personnel
...
**Agent Deck will not pursue legal action** against individuals reporting
vulnerabilities responsibly.

Researchers who submit valid and impactful reports may also receive
**recognition** or other discretionary rewards, at Agent Deck's sole
discretion.
...
Agent Deck may offer monetary rewards for qualifying vulnerability reports.
