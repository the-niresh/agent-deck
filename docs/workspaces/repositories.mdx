...
When you add a repository to a workspace, Agent Deck creates a **git worktree** - a separate working directory linked to your repository.
...
**Where worktrees are stored:** In the `.agent-deck-workspaces` directory (configurable in Settings).
</Accordion>
