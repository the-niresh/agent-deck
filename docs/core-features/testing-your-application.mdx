...
Preview Mode provides an embedded browser experience within Agent Deck, allowing you to test and iterate on your web applications without leaving the development environment. This feature eliminates the need to switch between your browser and Agent Deck by providing live preview capabilities and precise component selection tools.

**Key Benefits:**
- **Embedded viewing**: See your application running directly in Agent Deck
...
<Step title="Install Web Companion">
  For precise component selection, install the `agent-deck-web-companion` package in your application.

  <Info>
  **Recommended**: Use the "Install companion automatically" button in the Preview tab to have Agent Deck create a task that installs and configures the companion for you.
  ...
  **Manual Installation:**
  ...
  ```bash
  npm install agent-deck-web-companion
  ```
  ...
  <Tab title="Create React App">
    ...
    ```jsx
    import { AgentDeckWebCompanion } from 'agent-deck-web-companion';
...
3. **Interact with your app** directly within Agent Deck
...
<Step title="Activate Selection Mode">
  Click the floating Agent Deck companion button in the bottom-right corner of your application to activate component selection mode.
...
<Step title="Choose Component Depth">
  When you click a component, Agent Deck shows a hierarchy of components from innermost to outermost. Select the appropriate level for your feedback:
...
- [Configuration & Customisation](/configuration-customisation/global-settings) - Customise Agent Deck settings
