...
<Tip>
For detailed setup instructions and examples, see the [Agent Deck MCP Server](/integrations/agent-deck-mcp-server) documentation.
</Tip>
...
The MCP client will automatically generate structured tasks in your Agent Deck project based on this description.
