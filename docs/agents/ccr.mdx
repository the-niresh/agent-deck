...
## Authentication
Authenticate and configure CCR outside of Agent Deck. Follow the instructions on the CCR GitHub repo:
...
Agent Deck does not ship a default configuration for CCR. Add configurations to the existing Claude Code agent:
...
### Example: Claude Code agent configuration in Agent Deck

<Frame>
<img src="/images/vk-ccr-agent-config.png" alt="Claude Code agent configuration in Agent Deck" />
</Frame>

## Using CCR in Agent Deck
