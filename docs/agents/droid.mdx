...
<Step title="Authenticate with Factory AI">
  To use Droid in Agent Deck, you must first authenticate:
...
Droid supports several configuration options in Agent Deck:
...
These options can be configured when creating agent configurations in Agent Deck.
