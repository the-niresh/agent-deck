...
description: "Common issues and solutions when using Agent Deck"
---
...
If you encounter irrecoverable errors and need to completely wipe your Agent Deck database, you can delete the application data directory for your operating system.
...
<Tab title="macOS">
```bash
~/Library/Application Support/ai.bloop.agent-deck/
```
</Tab>
...
<Tab title="Windows">
```
%APPDATA%\bloop\agent-deck\
```

Typically: `C:\Users\<username>\AppData\Roaming\bloop\agent-deck\`
</Tab>
</Tabs>

After deleting the application data directory, restart Agent Deck to reset with an empty database and default settings.
